...
\begin{figure}[htbp]
    \centering
    \centerline{\includegraphics[height=4.1in]{benchmark_requirements}}
...
\begin{figure}[htbp]
    \centering
    \centerline{\includegraphics[height=6.2in]{canvas}}
...
\begin{figure}[htbp]
    \centering
    \centerline{\includegraphics[height=3.6in]{artillery-operator-architecture}}
...
\begin{figure}[htbp]
    \centering
    \centerline{\includegraphics[height=3.3in]{Results/R/Cpu-R}}
...
\begin{figure}[htbp]
    \centering
    \centerline{\includegraphics[height=3.3in]{Results/R/Memory-R}}
...
\begin{figure}[htbp]
    \centering
    \centerline{\includegraphics[height=3.3in]{Results/R/Latency-R}}
...
\begin{figure}[htbp]
    \centering
    \centerline{\includegraphics[height=2.7in]{bipartExperiment}}
