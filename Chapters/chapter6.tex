...
the point-to-point experiment, the weighted point-to-point experiment, the bi-partition experiment, and the live contract upgrade experiment.
...
It is expected that the latency will steadily increase as the proportion of requests routed through the adapter increases, because of the same reasons previously stated.
