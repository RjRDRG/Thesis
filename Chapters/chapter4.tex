...
\paragraph{Alternatives:}
Information collected about the active services and dependencies between procedures can be translated into an ontology language \cite{ontology} and stored in a registry.
...
\subsection{Supported Contract Changes} % (fold)
