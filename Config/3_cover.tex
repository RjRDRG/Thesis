...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,f){Carla Ferreira, Associate Professor, FCT NOVA University Lisbon}
% Co-advisers(s)
\ntaddperson{adviser}(c,m){João Costa Seco, Associate Professor, FCT NOVA University Lisbon}
...
%                           [m] for male
%         You may use "\\" to force line breaks
\ntaddperson{committee}(r,m){Alcides Miguel C. Aguiar Fonseca, Assistant Professor, Faculty of Sciences of the University of Lisbon}
\ntaddperson{committee}(m,f){Carla Ferreira, Associate Professor, FCT NOVA University Lisbon}
\ntaddperson{committee}(c,m){Henrique João Lopes Domingos, Associate Professor, FCT NOVA University Lisbon}
